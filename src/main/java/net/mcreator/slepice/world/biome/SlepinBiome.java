...
package net.mcreator.slepice.world.biome;
...
import net.mcreator.slepice.entity.KfcmobEntity;
import net.mcreator.slepice.block.StromBlock;
import net.mcreator.slepice.block.SlepwoodBlockBlock;
import net.mcreator.slepice.block.RedgrassBlock;
...
public class SlepinBiome extends SlepiceModElements.ModElement {
	public static Biome biome;
	public SlepinBiome(SlepiceModElements instance) {
		super(instance, 24);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-52429).setWaterColor(-10027009).setWaterFogColor(-6684724)
						.withSkyColor(-52429).withFoliageColor(-13108).withGrassColor(-39322).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(RedgrassBlock.block.getDefaultState(),
								Blocks.STONE.getDefaultState(), Blocks.STONE.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(SlepwoodBlockBlock.block.getDefaultState()),
										new SimpleBlockStateProvider(StromBlock.block.getDefaultState()),
										new MegaPineFoliagePlacer(FeatureSpread.func_242252_a(0), FeatureSpread.func_242252_a(0),
												FeatureSpread.func_242253_a(13, 4)),
										new GiantTrunkPlacer(21, 2, 14), new TwoLayerFeature(1, 1, 2)))
				...
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(KfcmobEntity.entity, 20, 4, 4));
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(0.1f).scale(0.2f).temperature(0.5f)
						.downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("slepice:slepin"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("slepin_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, Blocks.SUGAR_CANE.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("slepin_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("slepin_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}

...
public class RedgrassBlock extends SlepiceModElements.ModElement {
	@ObjectHolder("slepice:redgrass")
	public static final Block block = null;
	public RedgrassBlock(SlepiceModElements instance) {
		super(instance, 24);
	}
